...
var activeHome = pathname === '/' ? 'active' : '';
var activenew = pathname === '/new' ? 'active' : ''; 
var activeteste = pathname === '/teste' ? 'active' : ''; 
  ...
  return (    
     ...
     <section className="sidebar">   
       ...
       <ul className="sidebar-menu" data-widget="tree">
         <li className="header">MAIN NAVIGATION{pathname}</li>
         <li className="active treeview menu-open">
           ...
           <ul className="treeview-menu">
             <li className={activeHome}><a href="/"><i className="fa fa-circle-o"></i> Posts</a></li>
             <li className={activenew}><a href="/new"><i className="fa fa-circle-o"></i> New</a></li>
             <li className={activeteste}><a href="/teste"><i className="fa fa-circle-o"></i> teste</a></li>
